...
6. If setup is incomplete (missing Upstash, Telegram owner id, or Vercel link), resume the relevant eve integration setup or use the provider CLI/MCP—never ask the owner to paste secrets into this chat.
